...
/*
 * Documentation:
 * Table — https://app.subframe.com/8fbe3cdb8345/library?component=Table_142dfde7-d0cc-48a1-a04c-a08ab2252633
 * Badge — https://app.subframe.com/8fbe3cdb8345/library?component=Badge_97bdb082-1124-4dd7-a335-b14b822d0157
  ...
  function HeaderCell(
    ...
    return (
      <th {...otherProps}>
        <div
          className={SubframeUtils.twClassNames(
            "group/a3a9d884 flex h-8 w-full items-center gap-1 px-3",
            className
          )}
          ref={ref as any}
        >
          {children ? (
            <span className="text-caption-bold font-caption-bold text-subtext-color whitespace-normal break-normal">
              {children}
            </span>
          ) : null}
          {icon ? (
